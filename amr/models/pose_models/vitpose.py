...
# Add ViTPose to path FIRST before any mmpose imports
vitpose_path = Path(__file__).parent.parent.parent.parent / "third-party" / "ViTPose"
if str(vitpose_path) not in sys.path:
    sys.path.insert(0, str(vitpose_path))

# Now import from ViTPose's mmpose (which includes custom backbones)
