...
from ..components.transformer import LayerNorm32
...
class ViT(nn.Module):
    ...
    def __init__(
        ...
        # Cache resized absolute positional embeddings for common sizes.
        self._abs_pos_cache = {}
    ...
    def forward_features(self, x, extra_embed=None):
        ...
        if self.pos_embed is not None:
            # The cls token embedding is added as a constant offset to all tokens.
